...
const pageOneText = [
  {
    text: "Problems around the house?",
    class: "text-5xl font-bold text-green-700",
  },
  {
    text: "Find local professionals near you!",
    class: "text-4xl font-bold text-green-700",
  },
  {
    text: "Schedule an appointment today.",
    class: "text-3xl font-semibold text-center text-green-700",
  },
];
...
<template>
  <div class="flex flex-col items-center">
    <main class="min-h-screen w-full flex flex-col items-center gap-16">
      ...
      <div
        class="flex flex-wrap items-center justify-center scale-[2] p-6 rounded-lg"
      >
        <div class="flex flex-col items-center">
          <a href="#/Form">
            <Button
